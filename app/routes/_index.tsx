...
export const meta: MetaFunction = () => {
  return [
    ...
    {
      name: "description",
      content: "Cambridge badminton for intermediate players",
    },
  ];
};
  ...
  return (
    <>
      <Section content="center" px="9">
        ...
        <Separator size="4" />
        <Grid gap="6" columns={{ xs: "1", sm: "2" }} mt="6">
          <Flex justify={{ xs: "center", sm: "end" }}>
            <iframe
      ...
      <Section px="9" ref={scrollRef}>
        <Grid gap="6" columns={{ xs: "1", sm: "2" }}>
          <Flex justify={{ xs: "center", sm: "end" }}>
            <Card variant="classic" style={{background: "var(--blue-10)"}}>
              <Box p="2" maxWidth="500px">
                ...
                <Flex direction="column" gap="4">
                  <Text>
                    ...
                    questions for yourself in order to assess your skill level
                    appropriately:
                  </Text>
                  <Flex gap="2" direction="column" pl="4">
                    ...
                    <li>
                      <Text>
                        Can you play serves tight to the top of the net and the
                        service line?
                      </Text>
                    </li>
                    <Separator size="4" />
                    <li>
                      <Text>
                        ...
                        involve large amounts of movement all around the court?
                      </Text>
                    </li>
                  </Flex>
                  <Text>
                    If you're answers to all the above are yes, then please
                    apply! If not, your probably aren't the right level for us
                    and should consider looking for a more beginner-friendly
                    group.
                  </Text>
                </Flex>
              </Box>
          ...
          >
            ...
            <Callout.Root>
              <Callout.Text>
                <Strong>
                  Please do not message unless you believe you meet the required
                  skill level.
                </Strong>{" "}
